...
//   pinkyMeta.write(map(cmd_msg.data[14], 0, 90, 0, 120));
        ...
        handMsg.data[3] = map(maptopercentage(hand_msg.thumb_finger(), 2150, 1780),0,100,0,90);
        handMsg.data[4] = map(maptopercentage(hand_msg.thumb_finger(), 2150, 1780),50,100,0,90);

        handMsg.data[6] = map(maptopercentage(hand_msg.index_finger(), 2150, 1800),0,100,0,90);
        handMsg.data[7] = map(maptopercentage(hand_msg.index_finger(), 2150, 1800),50,100,0,90);

        handMsg.data[9] = map(maptopercentage(hand_msg.middle_finger(), 2150, 1750),0,100,0,90);
        handMsg.data[10] = map(maptopercentage(hand_msg.middle_finger(), 2150, 1750),50,100,0,90);

        handMsg.data[11] = map(maptopercentage(hand_msg.ring_finger(), 34640, 27072),0,100,0,90);
        handMsg.data[12] = map(maptopercentage(hand_msg.ring_finger(), 34640, 27072),50,100,0,90);

        handMsg.data[13] = map(maptopercentage(hand_msg.little_finger(), 33950, 30000),0,100,0,90);
        handMsg.data[14] = map(maptopercentage(hand_msg.little_finger(), 33950, 30000),50,100,0,90);
    ...
    float ros_translate::maptopercentage(int value, int upper, int lower) {
        float percentage;
        percentage = 100*(upper-value)/(upper-lower);
        return percentage;
    }
    float ros_translate::map(float x, float in_min, float in_max, float out_min, float out_max) {
        if (x > in_max)
        {
            return out_max;
        }
